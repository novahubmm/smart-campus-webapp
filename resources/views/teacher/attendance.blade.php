<x-app-layout>
        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Mark and manage student attendance') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <div
            ...
            <div
                class="w-20 h-20 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center text-green-500 mb-6">
                <i class="fas fa-calendar-check text-3xl"></i>
            </div>
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">
                {{ __('Attendance Portal Coming Soon') }}
            </h3>
            <p class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-8">
                {{ __('We are currently building this section to help you efficiently record and track student attendance records.') }}
            </p>
            <a href="{{ route('teacher.academic') }}"
                class="px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-bold rounded-2xl transition-all active:scale-95">
