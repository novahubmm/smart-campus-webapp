<x-app-layout>
        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Review and approve leave applications from your students') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <div
            ...
            <div
                class="w-20 h-20 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center text-purple-500 mb-6">
                <i class="fas fa-calendar-alt text-3xl"></i>
            </div>
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">
                {{ __('Leave Approval Coming Soon') }}
            </h3>
            <p class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-8">
                {{ __('We are currently building this section to help you manage student leave requests directly through the portal.') }}
            </p>
            <a href="{{ route('teacher.utilities') }}"
                class="px-6 py-3 bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-2xl transition-all active:scale-95">
