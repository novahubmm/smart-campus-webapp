<x-app-layout>
    <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('teacher.utilities') }}" class="flex items-center text-gray-600 dark:text-gray-300">
                ...
                <div
                    ...
                    <div class="p-6 lg:col-span-2">
                        ...
                        <div
                            ...
                            {!! nl2br(e($settings['school_about_us'] ?? __('No information available.'))) !!}
                        </div>
                            ...
                            @if(!empty($settings['school_website']))
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ $settings['school_website'] }}" target="_blank"
                                            class="font-semibold text-blue-600 dark:text-blue-400 hover:underline">
                                            {{ str_replace(['http://', 'https://'], '', $settings['school_website']) }}
                                        </a>
                                    </div>
                                </div>
                            @endif
