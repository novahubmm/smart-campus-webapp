        ...
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-white leading-tight">
                    {{ __('homework.Homework') }}
                </h2>
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Assign and review student homework') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <div
            ...
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">
                {{ __('Homework Portal Coming Soon') }}
            </h3>
            <p class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-8">
                {{ __('We are currently building this section to help you assign, track and grade student homework digitally.') }}
            </p>
            <a href="{{ route('teacher.academic') }}"
