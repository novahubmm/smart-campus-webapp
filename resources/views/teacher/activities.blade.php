        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('View and manage your recorded activities during free periods') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <div
            ...
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">
                {{ __('Activities Portal Coming Soon') }}
            </h3>
            <p class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-8">
                {{ __('We are currently building this section to help you track and record your professional activities during non-teaching periods.') }}
            </p>
            <a href="{{ route('teacher.utilities') }}"
