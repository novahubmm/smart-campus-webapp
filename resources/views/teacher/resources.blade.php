        ...
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">
                    {{ __('Access class logs, history and important resources') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6">
        <div
            ...
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">
                {{ __('Class Records Coming Soon') }}
            </h3>
            <p class="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-8">
                {{ __('We are currently building this section to help you access and manage your class teaching history and logs.') }}
            </p>
            <a href="{{ route('teacher.academic') }}"
