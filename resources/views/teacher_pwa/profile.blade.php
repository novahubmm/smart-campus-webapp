...
<div class="pwa-container">
    ...
    <div class="pwa-profile-header">
        <img src="{{ $teacher->avatar ?? asset('images/default_profile.jpg') }}" alt="{{ $teacher->name }}" class="pwa-profile-photo">
        <h2 class="pwa-profile-name">{{ $teacher->name }}</h2>
        <p class="pwa-profile-role">{{ $teacher->teacher_id }}</p>
        <p class="pwa-profile-department">{{ $teacher->department }}</p>
    </div>
    ...
    <div class="pwa-card">
        ...
        <div class="pwa-info-list">
            <div class="pwa-info-item">
                ...
                <span class="pwa-info-value">{{ $teacher->email }}</span>
            </div>
            <div class="pwa-info-item">
                <span class="pwa-info-label">Phone</span>
                <span class="pwa-info-value">{{ $teacher->phone }}</span>
            </div>
            <div class="pwa-info-item">
                <span class="pwa-info-label">Department</span>
                <span class="pwa-info-value">{{ $teacher->department }}</span>
            </div>
            <div class="pwa-info-item">
                <span class="pwa-info-label">Subjects</span>
                <span class="pwa-info-value">{{ implode(', ', $teacher->subjects) }}</span>
            </div>
        </div>
    </div>
