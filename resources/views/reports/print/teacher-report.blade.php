...
<head>
    ...
    <title>{{ ucfirst($reportType) }} - Teacher Report</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-btn { position: fixed; top: 20px; right: 20px; padding: 10px 20px; background: #059669; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 14px; }
...
<body>
    ...
    <div class="page">
        <div class="header">
            ...
            <h2>Teacher {{ ucfirst($reportType) }} Report</h2>
        </div>

        <table class="info-table">
            <tr>
                <td class="label">Name:</td>
                <td>{{ $teacher->user->name ?? $teacher->name ?? 'N/A' }}</td>
            </tr>
            <tr>
    ...
    <div class="page">
        <div class="placeholder">
            ...
            <p>No teachers match the selected criteria.</p>
        </div>
    </div>
    @endforelse
</body>
