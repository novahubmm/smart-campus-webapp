...
{
    public function __construct(private readonly StaffAttendanceRepositoryInterface $repository) {}
    ...
    public function staffDetail(string $staffId, string $start, string $end): array
    {
        return $this->repository->getStaffDetail($staffId, Carbon::parse($start), Carbon::parse($end));
    }
}
