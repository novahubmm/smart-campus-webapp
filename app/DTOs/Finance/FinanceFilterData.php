...
class FinanceFilterData
{
    ...
    public static function from(array $input): self
    {
        ...
        return new self(
            ...
            feePaymentDate: Arr::get($input, 'fee_payment_date'),
            incomeDate: Arr::get($input, 'income_date'),
            expenseDate: Arr::get($input, 'expense_date'),
            dailyPlDate: Arr::get($input, 'daily_pl_date'),
            monthlyPlPeriod: Arr::get($input, 'monthly_pl_period'),
