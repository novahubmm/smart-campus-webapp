    ...
    public function run(): void
    {
        $types = [
            ...
            [
                'name' => 'Holiday',
                'slug' => 'holiday',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM8.547 4.505a8.25 8.25 0 1011.672 11.672 1 1 0 01-.677-.677 8.25 8.25 0 01-10.995-10.995 1 1 0 01-.677-.677z" clip-rule="evenodd"/></svg>',
                'color' => '#22c55e',
                'sort_order' => 4,
            ],
            [
